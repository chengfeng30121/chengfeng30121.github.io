...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | chengfeng3012")[0];
}
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.cf3012.eu.org/webp/home_bg.webp);
    --darkmode-bg:url(https://tuchuang.cf3012.eu.org/webp/dark_mode.webp);
    --mobileday-bg: url(https://tuchuang.cf3012.eu.org/webp/home_bg.webp);
    --mobilenight-bg: url(https://tuchuang.cf3012.eu.org/webp/dark_mode.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
